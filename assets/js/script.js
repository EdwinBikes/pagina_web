...
(function(){
  ...
  const data={
    ...
    '3d':{kicker:'04 / FABRICACIÓN',title:'Impresión 3D',intro:'Diseño, prototipado e impresión de piezas personalizadas, funcionales y creativas.',html:`
      ...
      <div class="service-modal-card" style="margin-top:13px"><video controls preload="metadata" poster="./assets/videos/video.mp4"><source src="./assets/videos/video.mp4" type="video/mp4">Tu navegador no puede reproducir este video.</video><div class="service-modal-card-content"><small>VIDEO</small><h3>Proceso de impresión</h3><p>Cuando tengas el video real, guárdalo como <strong>assets/videos/impresion3d.mp4</strong>.</p></div></div>`}
  };
